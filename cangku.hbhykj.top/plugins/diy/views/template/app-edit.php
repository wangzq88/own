                                    ...
                                    <div class="diy-component-edit">
                                        <el-form label-width="100px">
                                            <el-card shadow="never">
                                                ...
                                                <el-form-item  v-if="[2,3,4].indexOf(Number(appNavBar.style)) !== -1" label="选择链接" prop="link">
                                            ...
                                            <el-card shadow="never" style="margin-top: 12px">
                                                ...
                                                <template v-if="!appNavBar.hasMallSetting">
                                                    <el-form-item v-if="[1,2,4].indexOf(Number(appNavBar.style)) !== -1" label="文字颜色" prop="color">
