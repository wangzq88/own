    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="form-body">
            <el-form :model="form" v-loading="loading" label-width="10rem" :rules="FormRules" ref="form">
                ...
                <el-form-item label="赠送的优惠券" prop="pt_coupon_id">
                    <el-select style="width: 100%" size='small' v-model="form.pt_coupon_id" filterable multiple placeholder="请选择">
                        <el-option
                                v-for="item in pt_coupon_list"
                                :key="item.id"
                                :label="item.name"
                                :value="item.id">
                        </el-option>
                ...
                <el-form-item prop="pt_coupon_num">
                    <template slot='label'>
                        <span>优惠券对应数量</span>
                        <el-tooltip effect="dark" content="按顺序"
                                    placement="top">
                            <i class="el-icon-info"></i>
                        </el-tooltip>
                    </template>
                    <el-input size="small" v-model="form.pt_coupon_num" autocomplete="off"></el-input>
                </el-form-item>


                <el-form-item label="赠送的加油券" prop="jy_coupon_id">
                    <el-select style="width: 100%" size='small' v-model="form.jy_coupon_id" filterable multiple placeholder="请选择">
                        <el-option
                                v-for="item in jy_coupon_list"
                                :key="item.id"
                                :label="item.name"
                                :value="item.id">
                        </el-option>
                ...
                <el-form-item prop="jy_coupon_num">
                    <template slot='label'>
                        <span>加油券对应数量</span>
                        <el-tooltip effect="dark" content="按顺序"
                                    placement="top">
                    ...
                    <el-input size="small" v-model="form.jy_coupon_num" autocomplete="off"></el-input>
                </el-form-item>
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    ...
                    this.loading = false;
                    this.pt_coupon_list = e.data.data.pt_coupon_list;
                    this.jy_coupon_list = e.data.data.jy_coupon_list;
                    if (e.data.code == 0) {
