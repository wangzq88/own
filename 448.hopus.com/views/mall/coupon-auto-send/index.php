            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column prop="event" label="触发事件">
                    <template slot-scope="scope">
                        ...
                        <span v-else-if="scope.row.event == 6">扫码领券
                           <a v-if="scope.row.file_path!='0'" :href="scope.row.file_path" target="_blank">
                               <img v-if="scope.row.file_path!='0'" style="width: 50px;height: 50px;" :src="scope.row.file_path"/>
                           </a>
                          </span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button v-if="scope.row.event==6" type="text" size="mini" circle style="margin-left: 10px;margin-top: 10px" @click.native="getMa(scope.row)">
                            <el-tooltip class="item" effect="dark" content="生成二维码" placement="top">
...
<script>
    const app = new Vue({
        ...
        methods: {
            ...
            //删除
            getMa: function(column) {

                request({
                    params: {
                        r: 'mall/coupon-auto-send/get-ma',
                        id: column.id
                    },
                    method: 'get'
                }).then(e => {
