...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <span>优惠券管理</span>
            <el-button style="float: right; margin: -5px 0" type="primary" size="small" @click="$navigate({r:'mall/coupon/edit1'})">新增
            </el-button>
        </div>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            handleEdit: function(row, column) {
                navigateTo({ r: 'mall/coupon/edit1', id: column.id });
            },

            // 优惠券发放页面
            handleSend: function(row, column) {
                navigateTo({ r: 'mall/coupon/send1', id: column.id });
            },
