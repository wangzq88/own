 ...
 */
Yii::$app->loadViewComponent('order/app-search1');
            ...
            <div v-loading="loading" v-if="list && list.length > 0">
                <el-card
                    ...
                    <div slot="header" class="app-order-head" flex="cross:center">
                        ...
                        <div class="app-order-user" v-if="item.store_name">
                            <span class="app-order-time">加油站：</span>{{ item.store_name }} (地址：{{item.store_address}})
                        </div>
                    ...
                    <div class="app-order-body">
                                    ...
                                    <div style="width: 250px" flex="dir:left box:mean">
                                        <div flex="dir:top main:center">
                                            ...
                                            <div v-if="item.plugin_data && item.plugin_data.price_list &&  item.plugin_data.price_list.length">
                                                <span>{{item.plugin_data.price_list[iIndex].label}}：￥{{item.total_price}}</span>
                                                <el-button type="text"
                        ...
                        <div flex="cross:center" class="app-order-info" :style="{width:orderTitle[1].width}">
                            <div flex="dir:top">
                                ...
                                <div>
                                    <span>
                                        <span style="color: #909399" v-if="item.is_show_express === 1">(含运费￥{{item.express_price}})</span><br>
                                         <span style="color: #909399" >(直降￥{{item.js_discount_price}})</span><br>
                                         <span style="color: #909399" >(优惠券抵用￥{{item.coupon_discount_price}})</span>
                                        <el-button type="text"
