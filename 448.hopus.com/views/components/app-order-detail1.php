            ...
            <div class="table-body" v-loading="loading">
                ...
                <el-card shadow="never" style="margin-top: 15px;">
                    ...
                    <el-form label-width="200px" :model="order" class="app-order-count-price">
                        ...
                        <el-form-item label="直降" v-if="order.is_show_express === 1">
                            <span>￥{{ order.js_discount_price }}</span>
                        </el-form-item>
...
<script>
    Vue.component('app-order-detail1', {
        template: '#app-order-detail1',
        props: {
            getDetailUrl: {
                type: String,
