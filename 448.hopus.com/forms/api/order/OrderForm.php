    ...
    public function getList()
    {
        ...
        if($newList){
            foreach($newList as $k=>$v){
                ...
                if($jiayouOrderInfo){
                    $newList[$k]['js_discount_price'] = $jiayouOrderInfo['js_discount_price'];
                    ...
                    if($jiayouInfo){
                        ...
                        $newList[$k]['store_name'] = $storeInfo['name'];
                        $newList[$k]['store_address'] = $storeInfo['address'];
                        $newList[$k]['qianghao'] = $jiayouInfo['qianghao'];
                        $newList[$k]['youxing'] = $jiayouInfo['youxing'];
                    }else{
                        $newList[$k]['store_name'] = '';
                        $newList[$k]['store_address'] = '';
                        $newList[$k]['qianghao'] = '';
                        $newList[$k]['youxing'] = '';
                    }
                }else{
                    $newList[$k]['js_discount_price'] = 0;
                    $newList[$k]['store_name'] = '';
                    $newList[$k]['store_address'] = '';
                    $newList[$k]['qianghao'] = '';
                    $newList[$k]['youxing'] = '';
