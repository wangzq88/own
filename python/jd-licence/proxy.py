...
orderno = "ZF2021910737ISJ2xw"
secret = "a735057da9b247c39f7526b5a3f2beb6"
...
r = requests.get("https://www.ip138.com", headers=headers, proxies=proxy, verify=False,allow_redirects=False)
r.encoding='utf8'
print(r.status_code)
print(r.text)
