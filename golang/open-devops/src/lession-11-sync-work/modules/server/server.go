...
import (
	...
	cloudsync "open-devops/src/lession-11-sync-work/modules/server/cloud_sync"
	"open-devops/src/lession-11-sync-work/modules/server/web"
	"open-devops/src/lession-11-sync-work/modules/server/config"
	"open-devops/src/lession-11-sync-work/models"
	"open-devops/src/lession-11-sync-work/modules/server/rpc"
	"os"
	"os/signal"
	"path/filepath"
	"syscall"
