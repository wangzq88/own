...
import (
	...
	"open-devops/src/lession-7-json-rpc/modules/server/config"
	"open-devops/src/lession-7-json-rpc/models"
	"open-devops/src/lession-7-json-rpc/modules/server/rpc"
	"os"
	"os/signal"
	"path/filepath"
	"syscall"
