...
import (
	...
	"open-devops/src/lession-8-shell/modules/agent/config"
	"open-devops/src/lession-8-shell/modules/agent/rpc"
	"open-devops/src/lession-8-shell/modules/agent/info"
	"os"
	"os/signal"
	"path/filepath"
	"syscall"
